...
const DIRECTIVE = 'Order the armed forces to bomb the presidential palace in Havana as soon as possible. The Joint Chiefs are to work out the operational details.';
